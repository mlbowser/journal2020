...
![A graph shows the widths of credibility intervals of occupancy at true values of occupancy from 0.1 to 0.9 and the same true values of detection.](2020-12-17-1432_p_ci_width.png)\
Widths of 95% credibility intervals of occupancy (*ψ*) from 100 simulations at 9 values of *ψ* and detection probability (*p*). 

![A graph shows the widths of credibility intervals of detection probability at true values of occupancy from 0.1 to 0.9 and the same true values of detection.](2020-12-17-1432_psi_ci_width.png)\
